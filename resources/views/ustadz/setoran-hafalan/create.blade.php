...
@section('page-title', 'Input Setoran Hafalan')

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="{{ route('ustadz.setoran-hafalan.store') }}" method="POST">
            @csrf
            <div class="space-y-5">
                <div>
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="2" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm" placeholder="Catatan tambahan...">{{ old('catatan') }}</textarea>
                </div>
                <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                    ...
                    <a href="{{ route('ustadz.setoran-hafalan.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition">Batal</a>
                </div>
            </div>
        </form>
    </div>
